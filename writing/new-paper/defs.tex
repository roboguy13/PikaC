...
\newcommand {\keyword} [1] {\text{\lstinline[language=Pika]{#1}}}
...
\newcommand{\pointsto}{\text{\lstinline[language=Pika]{:->}}}
...
\lstdefinelanguage{Pika}{
  keywords={let, in, if, then, else, while, data, emp, generate, instantiate, lower, addr, deref, synth},
  ndkeywords={Int, Bool, layout, Ptr},
  literate={>->}{$\monic{}$}1
           {->}{$\ra{}$}1,
  mathescape=true,
  showspaces=false,
...
\lstdefinelanguage{SynLang}{
  keywords={new, let, if, else, null, return, while, emp, func, temp},
  ndkeywords={bool, int, void, loc, predicate},
  literate={->}{$\ra$}1,
  mathescape=true,
  showspaces=false,
  showtabs=false,
