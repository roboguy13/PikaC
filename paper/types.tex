...
\begin{figure}
  \[
    \begin{array}{c}
      ...
      \\\\
      \highlight{
      \labinfer[T-SSL]{E[\Delta;C;\Gamma] \vdash \ssl{\overline{x \mapsto e}} : \SSL(n)}
...
\[
  \instExpr_{a,b}(e) \mathrel{=}{\Delta} \apply_b(\apply_a(e))
\]

We further abbreviate $\instExpr_{a,b}(f)$ as $f_{a,b}$.
