...
\begin{abstract}
  ...
  We then develop a second version of \Pika{} extended with an additional synthesis feature. This synthesis feature allows SSL propositions to be included in type signatures. Then, an implementation is synthesized from the type signature using \SuSLik. These two versions of \Pika{} are compared.
